...
{
	[SamplePage(SampleCategory.UIComponents, "AutoSuggestBox", Description = "Represents a text control that makes suggestions to users as they enter text.", DocumentationLink = "https://learn.microsoft.com/en-us/uwp/api/windows.ui.xaml.controls.autosuggestbox", DataType = typeof(AutoSuggestBoxSamplePageViewModel))]
