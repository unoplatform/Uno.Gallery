...
{
	[SamplePage(SampleCategory.UIComponents, "MessageDialog", Description = "This represents a simple dialog to show to users. Customization is limited to title text, content text and commands.", DocumentationLink = "https://docs.microsoft.com/en-us/uwp/api/windows.ui.popups.messagedialog")]
