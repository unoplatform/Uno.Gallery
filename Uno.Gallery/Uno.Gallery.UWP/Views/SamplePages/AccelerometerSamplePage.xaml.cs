...
{
	[SamplePage(SampleCategory.NonUI, "Accelerometer", Description = "Represents an accelerometer sensor. This sensor returns G-force values with respect to the x, y, and z axes.", DocumentationLink = "https://learn.microsoft.com/en-us/windows/uwp/devices-sensors/use-the-accelerometer")]
