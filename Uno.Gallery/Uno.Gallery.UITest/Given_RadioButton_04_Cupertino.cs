...
namespace Uno.Gallery.UITests
{
	...
	public class Given_RadioButton_04_Cupertino : TestBase
	{
		...
		public void WhenRadioButtonCupertinoClick_01_Unchecked()
		{
			...
			App.ScrollDownTo(x => x.All().Marked("RadioButton_Cupertino_Unchecked"));
			...
			//App.ScrollDownTo(x => x.All().Marked("RadioButton_Cupertino_Checked"));
		...
		public void WhenRadioButtonCupertinoClick_02_DisabledUnchecked()
		{
			...
			//Scrolling to Unchecked option
			//App.ScrollDownTo(x => x.All().Marked("RadioButton_Cupertino_Disabled_Unchecked"));
			...
			//App.ScrollDownTo(x => x.All().Marked("RadioButton_Cupertino_Disabled_Checked"));
